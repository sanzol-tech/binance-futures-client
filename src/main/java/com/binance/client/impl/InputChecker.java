...
class InputChecker
{
	...
	<T> InputChecker shouldNotNull(T value, String name)
	{
		if (value == null)
		{
			throw new BinanceApiException(BinanceApiException.INPUT_ERROR, "[Input] " + name + " should not be null");
		}
		return checkerInst;
	}
	...
	<T> InputChecker shouldNull(T value, String name)
	{
		if (value != null)
		{
			throw new BinanceApiException(BinanceApiException.INPUT_ERROR, "[Input] " + name + " should be null");
		}
		return checkerInst;
	}
	...
	InputChecker checkSymbol(String symbol)
	{
		...
		{
			throw new BinanceApiException(BinanceApiException.INPUT_ERROR, "[Input] " + symbol + " is invalid symbol");
		}
		return checkerInst;
	}
	...
	InputChecker checkCurrency(String currency)
	{
		...
		{
			throw new BinanceApiException(BinanceApiException.INPUT_ERROR, "[Input] " + currency + " is invalid currency");
		}
		return checkerInst;
	}
	...
	private InputChecker checkRange(int size, int min, int max, String name)
	{
		...
		{
			throw new BinanceApiException(BinanceApiException.INPUT_ERROR, "[Input] " + name + " is out of bound. " + size + " is not in [" + min + "," + max + "]");
		}
		return checkerInst;
	}
	...
	InputChecker greaterOrEqual(Integer value, int base, String name)
	{
		...
		{
			throw new BinanceApiException(BinanceApiException.INPUT_ERROR, "[Input] " + name + " should be greater than " + base);
		}
		return checkerInst;
	}
	...
	<T> InputChecker checkList(List<T> list, int min, int max, String name)
	{
		if (list != null)
		{
			if (list.size() > max)
			{
				throw new BinanceApiException(BinanceApiException.INPUT_ERROR, "[Input] " + name + " is out of bound, the max size is " + max);
			}
			else if (list.size() < min)
			{
				throw new BinanceApiException(BinanceApiException.INPUT_ERROR, "[Input] " + name + " should contain " + min + " item(s) at least");
			}
		}
		return checkerInst;
	}
