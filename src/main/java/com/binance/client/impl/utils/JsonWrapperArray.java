...
public class JsonWrapperArray
{
	...
	public JsonWrapper getJsonObjectAt(int index)
	{
		if (array != null && array.size() > index)
		{
			...
			if (object == null)
			{
				throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Json] Cannot get object at index " + index + " in array");
			}
	...
	public JsonWrapperArray getArrayAt(int index)
	{
		if (array != null && array.size() > index)
		{
			...
			if (newArray == null)
			{
				throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Json] Cannot get array at index " + index + " in array");
			}
	...
	public long getLongAt(int index)
	{
		...
		{
			throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Json] Cannot get long at index " + index + " in array: " + e.getMessage());
		}
	...
	public Integer getIntegerAt(int index)
	{
		...
		{
			throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Json] Cannot get integer at index " + index + " in array: " + e.getMessage());
		}
