...
public class JsonWrapper
{
	...
	public static JsonWrapper parseFromString(String text)
	{
		try
		{
			...
			{
				throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Json] Unknown error when parse: " + text);
			}
		}
	...
	private void checkMandatoryField(String name)
	{
		...
		{
			throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Json] Get json item field: " + name + " does not exist");
		}
	}
	...
	public String getString(String name)
	{
		...
		{
			throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Json] Get string error: " + name + " " + e.getMessage());
		}
	}
	...
	public boolean getBoolean(String name)
	{
		...
		{
			throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Json] Get boolean error: " + name + " " + e.getMessage());
		}
	}
	...
	public int getInteger(String name)
	{
		...
		{
			throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Json] Get integer error: " + name + " " + e.getMessage());
		}
	}
	...
	public long getLong(String name)
	{
		...
		{
			throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Json] Get long error: " + name + " " + e.getMessage());
		}
	}
	...
	public Double getDouble(String name)
	{
		...
		{
			throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Json] Get double error: " + name + " " + e.getMessage());
		}
	}
	...
	public BigDecimal getBigDecimal(String name)
	{
		...
		{
			throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Json] Get decimal error: " + name + " " + e.getMessage());
		}
	}
	...
	public JsonWrapperArray getJsonArray(String name)
	{
		...
		if (array == null)
		{
			throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Json] Array: " + name + " does not exist");
		}
