...
class ApiSignature
{
	...
	void createSignature(String accessKey, String secretKey, UrlParamsBuilder builder)
	{
		...
		builder.putToUrl("recvWindow", Long.toString(BinanceApiConstants.DEFAULT_RECEIVING_WINDOW)).putToUrl("timestamp", Long.toString(System.currentTimeMillis()));
		...
		{
			throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, "[Signature] No such algorithm: " + e.getMessage());
		}
