...
public class OrderBookEvent
{
	...
	{
		return new ToStringBuilder(this, BinanceApiConstants.TO_STRING_BUILDER_STYLE).append("eventType", eventType).append("eventTime", eventTime).append("transactionTime", transactionTime)
				.append("symbol", symbol).append("firstUpdateId", firstUpdateId).append("lastUpdateId", lastUpdateId).append("lastUpdateIdInlastStream", lastUpdateIdInlastStream).append("bids", bids)
