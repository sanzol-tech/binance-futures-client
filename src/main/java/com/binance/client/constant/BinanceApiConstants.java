...
public class BinanceApiConstants
{
	...
	/**
	 * Default ToStringStyle used by toString methods. Override this to change the output format of the overridden toString
	 * methods. - Example ToStringStyle.JSON_STYLE
	 */
